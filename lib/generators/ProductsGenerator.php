...
class ProductsGenerator
{
    ...
    public function generate()
    {
        ...
        array_push($products, new Product(1, "Original", $typesOfBeer->getTypeNameById(1), $brands->getBrandNameById(1), "1.20","FeldOriginal.png","5%","41 kcal"));
        ...
        array_push($products, new Product(7, "Original", $typesOfBeer->getTypeNameById(1), $brands->getBrandNameById(2), "2.60","heinOriginal.png","5.2%","40 kcal"));
